...
header("Access-Control-Allow-Origin: *"); // Allow access from any source (development only)
...
class service
{
    ...
    /** When switching to the combat version, replace with 'https://api.cdek.ru/v2'*/
